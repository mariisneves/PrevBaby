...
public class BaseSis extends Geral {
	...
	public void imprimir() {
		...
		{
			System.out.println("Sua pressão siastólica esta abaixo do esperada para semana");
		} 
		else if (getInd2() > (getInd1() - trimestre) + 3) 
		{
			System.out.println("Sua pressão siastólica esta acima do esperada para semana");
		} 
		else 
		{
			System.out.println("Sua pressão siastólica esta dentro do esperada para semana");
		}
