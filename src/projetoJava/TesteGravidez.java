...
public class TesteGravidez {
	...
	public static void main(String[] args) {
		...
		do {
			try {
				System.out.println("\n\n----------------- PrevBaby ---------------------");
				System.out.println("(1) Medir índice glicêmico");
				System.out.println("(2) Medir índice de pressão");
				System.out.println("(3) Medir índice de peso");
